...
boot_bias =  [bias_boot(x, sample_variance, nsamp=i)for i in np.linspace(1, B,300, dtype=int)]
...
axes[1].plot(np.linspace(1, B,300, dtype=int),[b['bias'] for b in boot_bias])
