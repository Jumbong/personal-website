...
- **Credit Scoring modellling approach.**
    ...
    - Model performances
- Sampling Bias and Class Imbalance (Oversampling and Undersampling) in Maximum-likelihood Logistic Regression ([bias_sample.qmd](Meduim/RegressionLogistique/bias_sample.qmd))

Meduim/RegressionLogistique/bias_sample.qmd
